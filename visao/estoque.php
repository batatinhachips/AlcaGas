...
<body class="estoque-page">
    <div class="container-estoque mt-5">
        <h2 class="estoque-title mb-4">Controle de Estoque</h2>
        ...
        <h2 class="estoque-title">Controle de Vendas</h2>
        ...
        <table class="table-estoque table table-striped mt-4" id="tabelaVendas">
